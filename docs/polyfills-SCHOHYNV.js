...
function dt() {
  ...
  let Y = class Y {
    ...
    static __load_patch(i, s, o = !1) {
      if (S.hasOwnProperty(i)) {
        ...
        if (!o && p) throw Error("Already loaded patch: " + i)
      } else if (!ae["__Zone_disable_" + i]) {
        let p = "Zone:" + i
        n(p), (S[i] = s(ae, Y, w)), a(p, p)
      }
    }
    get parent() {
      return this._parent
    ...
    runTask(i, s, o) {
      ...
      let p = i,
        { type: H, data: { isPeriodic: M = !1, isRefreshable: se = !1 } = {} } =
          i
      if (i.state === q && (H === z || H === g)) return
      let le = i.state != Z
      le && p._transitionTo(Z, d)
      let ue = D
      ;(D = p), (b = { parent: b, zone: this })
      try {
        ...
        let ne = i.state
        if (ne !== q && ne !== X)
          if (H == z || M || (se && ne === k)) le && p._transitionTo(d, Z, k)
          else {
    ...
    scheduleTask(i) {
      ...
      try {
        ...
        throw (
          (i._transitionTo(X, k, q), this._zoneDelegate.handleError(this, o), o)
        )
      }
      return (
    ...
    cancelTask(i) {
      ...
      if (!(i.state !== d && i.state !== Z)) {
        ...
        try {
          ...
          throw (
            (i._transitionTo(X, V), this._zoneDelegate.handleError(this, s), s)
          )
        }
        return (
    ...
    _updateTaskCount(i, s) {
      ...
      for (let p = 0; p < o.length; p++) o[p]._updateTaskCount(i.type, s)
    }
  }
  Y.__symbol__ = ee
  let t = Y,
  ...
  let T = ee("setTimeout"),
    ...
    I
  function x(j) {
    if ((I || (ae[m] && (I = ae[m].resolve(0))), I)) {
      let i = I[C]
      i || (i = I.then), i.call(I, j)
    } else ae[T](j, 0)
  }
  function U(j) {
    Q === 0 && _.length === 0 && x(J), j && _.push(j)
  }
  function J() {
    if (!P) {
      for (P = !0; _.length; ) {
  ...
  Ye = function (e) {
    ...
    if (Be && a === pe && e.type === "error") {
      ...
      (c = t && t.apply(this, arguments)),
        e.type === "beforeunload" && $[mt] && typeof c == "string"
          ? (e.returnValue = c)
      ...
      (function (c) {
        typeof a[c] == "function"
          ...
          : Ae($[e].prototype, c, {
              set: function (f) {
                typeof f == "function"
                  ? ((this[oe][c] = Ve(f, e + "." + c)), _e(this[oe][c], f))
                  : (this[oe][c] = f)
              },
              get: function () {
                return this[oe][c]
...
function pt(e, n, a) {
  ...
  t = de(
    ...
    f =>
      function (E, T) {
        let m = a(E, T)
        return m.cbIdx >= 0 && typeof T[m.cbIdx] == "function"
          ? Ge(m.name, T[m.cbIdx], m, c)
          : f.apply(E, T)
      }
  )
}
...
function Pt(e, n, a, t) {
  let c = (t && t.add) || He,
    ...
    I = function (k, d, Z) {
      ...
      typeof V == "object" &&
        V.handleEvent &&
        ((k.callback = g => V.handleEvent(g)), (k.originalDelegate = V))
      let X
      try {
        k.invoke(k, d, [Z])
      } catch (g) {
  ...
  function K(k, d) {
    ...
    let l = function (r, u, v, R, y = !1, O = !1) {
      return function () {
        ...
        if (ge) {
          if (((We = !0), X)) {
            for (let ce = 0; ce < ge.length; ce++) if (le(ge[ce], F)) return
          }
        } else ge = N[ze] = []
        let we,
  ...
  let q = []
  for (let k = 0; k < a.length; k++) q[k] = K(a[k], t)
  return q
}
function lt(e, n) {
  if (!n) {
  ...
  e.__load_patch("legacy", n => {
    ...
    e.__load_patch("XHR", (n, a) => {
      ...
      function C(_) {
        ...
        function k(w) {
          ...
          ;(D[E] = !1), (D[m] = !1)
          let Q = D[f]
          U || ((U = D[Le]), (J = D[Ie])), Q && J.call(D, K, Q)
          let W = (D[f] = () => {
        ...
        let V = de(
            ...
            () =>
              function (w, b) {
                return (w[c] = b[2] == !1), (w[T] = b[1]), V.apply(w, b)
              }
          ),
          ...
          z = de(
            ...
            () =>
              function (w, b) {
                if (a.current[g] === !0 || w[c]) return z.apply(w, b)
                {
                  let D = {
                      target: w,
                      url: w[T],
    ...
    e.__load_patch("PromiseRejectionEvent", (n, a) => {
      function t(c) {
        return function (f) {
          lt(n, c).forEach(T => {
            ...
            if (m) {
              let C = new m(c, { promise: f.promise, reason: f.rejection })
              T.invoke(C)
            }
          })
        }
      ...
      n.PromiseRejectionEvent &&
        ((a[A("unhandledPromiseRejectionHandler")] = t("unhandledrejection")),
    ...
    function Y(h, l, r) {
      ...
      if (h[k] === g) {
        ...
        if (
          ...
          for (let y = 0; y < R.length; ) s(h, R[y++], R[y++], R[y++], R[y++])
          if (R.length == 0 && l == S) {
            h[k] = w
            let y = r
            try {
...
` + r.stack
    ...
    function i(h) {
      if (h[k] === w) {
        ...
        h[k] = S
        for (let l = 0; l < m.length; l++) h === m[l].promise && m.splice(l, 1)
      }
    }
    ...
    class M {
      ...
      static any(l) {
        ...
        let r = [],
          u = 0
        try {
          for (let y of l) u++, r.push(M.resolve(y))
        } catch {
          return Promise.reject(new H([], "All promises were rejected"))
        }
        if (u === 0)
            ...
            r[N].then(
              ...
              L => {
                R.push(L),
                  u--,
                  u === 0 &&
                    ((v = !0), O(new H(R, "All promises were rejected")))
              }
            )
        })
      }
      static race(l) {
        ...
        for (let O of l) J(O) || (O = this.resolve(O)), O.then(R, y)
        return v
      }
      static all(l) {
      ...
      static allWithCallback(l, r) {
        ...
        for (let L of l) {
          ...
          try {
            L.then(
              B => {
                ;(N[F] = r ? r.thenCallback(B) : B), y--, y === 0 && u(N)
              },
              B => {
                r ? ((N[F] = r.errorCallback(B)), y--, y === 0 && u(N)) : v(B)
              }
            )
          } catch (B) {
            v(B)
        ...
        return (y -= 2), y === 0 && u(N), R
      }
      constructor(l) {
        let r = this
        if (!(r instanceof M)) throw new Error("Must be an instanceof Promise.")
        ;(r[k] = g), (r[d] = [])
        try {
          let u = D()
          l && l(u(b(r, z)), u(b(r, S)))
      ...
      then(l, r) {
        ...
        let v = new u(p),
          R = a.current
        return this[k] == g ? this[d].push(R, v, l, r) : s(this, R, v, l, r), v
      }
      catch(l) {
        ...
        u[Z] = Z
        let v = a.current
        return this[k] == g ? this[d].push(v, u, l, l) : s(this, v, u, l, l), u
      }
    }
    ;(M.resolve = M.resolve),
      (M.reject = M.reject),
        ...
        c.forEach(function (_) {
          ...
          try {
            if (I.hasOwnProperty(_)) {
              ...
              x && x.value
                ? ((x.value = e.wrapWithCurrentZone(x.value, P)),
                  e._redefineProperty(m.prototype, _, x))
